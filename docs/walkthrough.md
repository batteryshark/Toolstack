...
**admin web app** now runs and manages the whole stack — 242 tests pass
(124 broker + 37 toolyard + 23 client + 58 admin), incl. opt-in Docker runner tests
...
python3 -m unittest discover -s toolyard/tests -t .       # 37 tests (3 docker + 1 live-Infisical skipped)
