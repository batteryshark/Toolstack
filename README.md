...
**admin web app** + a desktop shell on top — 310 tests across [broker/](broker/),
[toolyard/](toolyard/), [client/](client/), [admin/](admin/), and [desktop/](desktop/). The
full vertical slice runs end to end:
